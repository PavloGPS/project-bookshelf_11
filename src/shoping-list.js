...
//   localStorage.setItem('local', JSON.stringify(onLokaleShopingList));
//   console.log(JSON.parse(localStorage.getItem('local')));
// }

// const shoppingList =
//   JSON.parse(localStorage.getItem('onLokaleShopingList')) || [];
...
//       const buyLinks = buy_links.filter(index => linksToShow.includes(index));
//       return `
//         <div class="book-card">
